...
$(INSTALLED_RECOVERYIMAGE_TARGET): $(MKBOOTIMG) \
	...
	@echo -e "$(MKBOOTIMG) $(INTERNAL_RECOVERYIMAGE_ARGS) $(BOARD_MKBOOTIMG_ARGS) --dt device/samsung/matisse/kernel/dt.img --output $@"
	$(hide) $(MKBOOTIMG) $(INTERNAL_RECOVERYIMAGE_ARGS) $(BOARD_MKBOOTIMG_ARGS) --dt device/samsung/matisse/kernel/dt.img --output $@ --ramdisk $(LZMA_RAMDISK)
...
DTBTOOL := device/samsung/matisse/kernel/dtbToolCM
