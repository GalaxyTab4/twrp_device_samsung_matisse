...
ifneq ($(TWRP_PRE),true)
TARGET_KERNEL_CONFIG := twrpsave_matissewifi_defconfig
...
# Recovery
TARGET_RECOVERY_FSTAB  := device/samsung/matisse/recovery.fstab
TARGET_RECOVERY_INITRC := device/samsung/matisse/init.rc
